...
| 文档 | 路径                 | 用途 |
|------|--------------------|------|
| 项目规范总览 | `./00-项目规范总览.md`   | 项目整体规范 |
| 开发规范 | `./01-开发规范.md`     | 数据库/日志/注释/安全/Git规范 |
| 接口规范 | `./02-接口规范.md`     | URL格式/端类型/响应格式 |
| 代码模板 | `./03-代码模板.md`     | CRUD 代码模板 |
| 公共类规范 | `./04-公共类规范.md`    | R类/异常/Redis/工具类 |
| Docker部署 | `./05-Docker部署.md` | 部署配置 |
...
com.{company}.{project}.{module}.model.request.{Entity}CreateRequest
com.{company}.{project}.{module}.model.response.{Entity}Response
