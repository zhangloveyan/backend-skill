...
POST   /toy/api/v1/user/bind-phone         # 绑定手机号
...
```
# 分页参数
GET /toy/web/v1/user/page?pageNum=1&pageSize=10

# 筛选参数
GET /toy/web/v1/user/page?status=1&keyword=张三

# 排序参数
GET /toy/web/v1/user/page?sortField=createTime&sortOrder=desc

# 时间范围
GET /toy/web/v1/order/page?startTime=2024-01-01&endTime=2024-12-31
```
...
// 更新请求
PUT /toy/web/v1/user/123/update
{
